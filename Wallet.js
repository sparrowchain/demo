...
import michaelQR from "./images/michaelQR.png";
import mandeepQR from "./images/mandeepQR.png";
...
renderMain(){
  ...
  return(
    ...
    <MainDiv>
    <StyledProfile>
    <ShareImg src={shareImg} onClick={()=>this.showShare()}/>
    ...
    <StyledFriendList>
    {showFriendList(this.props.user)}
...
render(){
  if(this.state.showShare){
    return(
      <MainDiv>
    <div><img src={keys[this.props.user].QR}/></div>
    <SmallText>{'http://demo.sparrowchain.com/user/'+this.props.user}</SmallText>
    <MidText onClick={()=>this.showShare()}>back</MidText>
</MainDiv>
